...
class _BookingManagementScreenState extends State<BookingManagementScreen> {
  ...
  Future<void> _loadData() async {
    try {
      ...
      // Load cinemas
      _cinemaService.getAllCinemas().listen((cinemaList) {
        setState(() {
          cinemas = cinemaList;
        });
      });
      ...
      // Load tickets
      _ticketService.getAllTickets().listen((ticketList) {
        setState(() {
          tickets = ticketList;
          isLoading = false;
        });
  ...
  Widget _buildProvinceSelector() {
    final provinces = cinemas.map((c) => c.provinceId).toSet().toList();
    return Container(
      ...
      child: DropdownButtonFormField<String>(
        ...
        items: provinces.map((provinceId) {
          return DropdownMenuItem<String>(
            value: provinceId,
            child: Text(provinceId),
          );
        }).toList(),
  ...
  Widget _buildTicketsList() {
    ...
    List<Ticket> filteredTickets = tickets.where((ticket) {
      ...
      return matchesDate && matchesCinema && matchesSearch;
    }).toList();
